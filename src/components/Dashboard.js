  ...
  const fetchWeight = () => {
    ...
    if (month === String(Currmonth)) {
      ...
      if (Days31.includes(Number(month))) {
        today.setDate(31);
      } else if (Days30.includes(Number(month))) {
        today.setDate(30);
      } else if (Days28.includes(Number(month))) {
        today.setDate(28);
      }
  ...
  const renderTimeLogs = () => {
    ...
    if (coreContext.patients.length > 0) {
      localStorage.setItem(
        "patient_list",
        JSON.stringify(coreContext.patients)
      );
      ...
      coreContext.patients.map((curr) => {
        ...
        BP.map((bpcurr) => {
          if (
            !bpdates.includes(Moment(bpcurr.CreatedDate).format("YYYY-MM-DD"))
          ) {
        ...
        BG.map((bgcurr) => {
          if (
            !bpdates.includes(Moment(bgcurr.CreatedDate).format("YYYY-MM-DD"))
          ) {
        ...
        WS.map((wscurr) => {
          if (
            !bpdates.includes(Moment(wscurr.CreatedDate).format("YYYY-MM-DD"))
          ) {
        ...
        if (patientTimelog.length > 0) {
          ...
          if (
            ...
            if (BillingCCM.length < 1) {
              BillingCCM.push({
                id: BillingCCM.length + 1 + 90,
                userId: curr.userId,
                name: curr.name,
                totalTime: totalTimeLog,
                rpmbills: 0,
                cptcode: curr.cptcodeforccm.slice(0, -1),
                ccmbills:
                  Math.floor(totalTimeLog / 1200) > 3
                    ? 3
                    : Math.floor(totalTimeLog / 1200),
                timeLeft: Math.floor((totalTimeLog / 60).toFixed(3)) % 20,
                "RPM Mins":
                  Math.floor(totalTimeLogForDataReview / 60) +
                  ":" +
                  (totalTimeLogForDataReview % 60),
                "CCM Mins":
                  Math.floor(totalTimeLog / 60) + ":" + (totalTimeLog % 60),
                "Days Reading": [...new Set(bpdates)].length,
          ...
          if (
            ...
            totalTimeLogForDataReview > 600 &&
            totalTimeLogForDataReview <= 1200 &&
            curr.program.includes("RPM")
          ) {
            // setOnetonine(onetonine+1)
            ...
            totalTimeLogForDataReview >= 1200 &&
            totalTimeLogForDataReview < 2400 &&
            curr.program.includes("RPM")
          ) {
            // setOnetonine(onetonine+1)
            ...
            if (BillingRPM.length < 1) {
              BillingRPM.push({
                id: BillingRPM.length + 1,
                userId: curr.userId,
                name: curr.name,
                totalTime: totalTimeLogForDataReview,
                ccmbills: 0,
                cptcode: curr.cptcodeforrpm.slice(0, -1),
                rpmbills:
                  Math.floor(totalTimeLogForDataReview / 1200) > 3
                    ? 3
                    : Math.floor(totalTimeLogForDataReview / 1200),
                timeLeft: Math.floor(totalTimeLogForDataReview / 60) % 20,
                "RPM Mins":
                  Math.floor(totalTimeLogForDataReview / 60) +
                  ":" +
                  (totalTimeLogForDataReview % 60),
            ...
            totalTimeLogForDataReview >= 2400 &&
            totalTimeLogForDataReview <= 3600 &&
            curr.program.includes("RPM")
          ) {
            // setOnetonine(onetonine+1)
        ...
        <div className="row">
          <div className="col mb-2">
            <h1 className="mb-2 pb-0 display-4" id="title">
              A Pattern Medical Clinic Dashboard
            </h1>
          </div>
        </div>
      </div>
        ...
        <div className="col-xl-12 py-2">
          ...
          <div className="card mb-3">
            <div className="card-header bg-primary pt-2 pb-2">
              {" "}
              <h3 className="text-white mb-0">Chronic Care Management</h3>
            </div>
            <div className="card-body">
              <div className="row g-0 align-items-center">
                          ...
                          <td>
                            ...
                            <Link
                              ...
                              onClick={() =>
                                setPatient(
                                  [...new Set(CCMPatient)],
                                  `${months[month]} 2022 Logs(CCM)`
                                )
                              }
                            >
                              {[...new Set(CCMPatient)].length}
                            </Link>{" "}
                          </td>
                          <td>
                            {" "}
                            <Link
                              ...
                              onClick={() =>
                                setPatient(
                                  sixty,
                                  `${months[month]} 2022 60+ Mins Logs(CCM)`
                                )
                              }
                            >
                              {sixty.length}
                          ...
                          <td>
                            <Link
                              ...
                              onClick={() =>
                                setPatient(
                                  fiftynine,
                                  `${months[month]} 2022 40-60 Mins Logs(CCM)`
                                )
                              }
                            >
                              {fiftynine.length}
                          ...
                          <td>
                            <Link
                              ...
                              onClick={() =>
                                setPatient(
                                  thirtynine,
                                  `${months[month]} 2022 20-40 Mins Logs(CCM)`
                                )
                              }
                            >
                              {thirtynine.length}
                          ...
                          <td>
                            <Link
                              ...
                              onClick={() =>
                                setPatient(
                                  nineteen,
                                  `${months[month]} 2022 10-20 Mins Logs(CCM)`
                                )
                              }
                            >
                              {nineteen.length}
                          ...
                          <td>
                            ...
                            <Link
                              ...
                              onClick={() =>
                                setPatient(
                                  nine,
                                  `${months[month]} 2022 1-10 Mins Logs(CCM)`
                                )
                              }
                            >
                              {nine.length}
                          ...
                          <td>
                            ...
                            <Link
                              ...
                              onClick={() =>
                                setPatient(
                                  zero,
                                  `${months[month]} 2022 0-1 Mins Logs(CCM)`
                                )
                              }
                            >
                              {zero.length}
                          ...
                          <td>
                            <Link
                              ...
                              onClick={() =>
                                setPatient(
                                  inactive,
                                  `${months[month]} 2022 0 Mins Logs(CCM)`
                                )
                              }
                            >
                              {inactive.length}
          ...
          <div className="card mb-3">
            <div className="card-header bg-primary pt-2 pb-2">
              {" "}
              <h3 className="text-white mb-0"> Data Review & Management</h3>
            </div>
            <div className="card-body">
              <div className="row g-0 align-items-center">
                <div className="col-xl-12">
                          ...
                          <td>
                            ...
                            <Link
                              ...
                              onClick={() =>
                                setPatient(
                                  [...new Set(RPMPatient)],
                                  `${months[month]} 2022 Logs(RPM)`
                                )
                              }
                            >
                              {[...new Set(RPMPatient)].length}
                            </Link>{" "}
                          </td>
                          <td>
                            {" "}
                            <Link
                              ...
                              onClick={() =>
                                setPatient(
                                  [...new Set(sixty1)],
                                  `Patients Information with time log between 60+ Mins of RPM of ${months[month]} month`
                                )
                              }
                            >
                          ...
                          <td>
                            <Link
                              ...
                              onClick={() =>
                                setPatient(
                                  [...new Set(fiftynine1)],
                                  `${months[month]} 2022 40-60 Mins Logs(RPM)`
                                )
                              }
                            >
                          ...
                          <td>
                            ...
                            <Link
                              ...
                              onClick={() =>
                                setPatient(
                                  [...new Set(thirtynine1)],
                                  `${months[month]} 2022 20-40 Mins Logs(RPM)`
                                )
                              }
                            >
                          ...
                          <td>
                            <Link
                              ...
                              onClick={() =>
                                setPatient(
                                  [...new Set(nineteen1)],
                                  `${months[month]} 2022 10-20 Mins Logs(RPM)`
                                )
                              }
                            >
                          ...
                          <td>
                            ...
                            <Link
                              ...
                              onClick={() =>
                                setPatient(
                                  [...new Set(nine1)],
                                  `${months[month]} 2022 1-10 Mins Logs(RPM)`
                                )
                              }
                            >
                          ...
                          <td>
                            <Link
                              ...
                              onClick={() =>
                                setPatient(
                                  [...new Set(zero1)],
                                  `${months[month]} 2022 0-1 Mins Logs(RPM)`
                                )
                              }
                            >
                          ...
                          <td>
                            ...
                            <Link
                              ...
                              onClick={() =>
                                setPatient(
                                  [...new Set(inactive)],
                                  `${months[month]} 2022 0 Mins Logs(RPM)`
                                )
                              }
                            >
          ...
          <div className="card mb-3">
            <div className="card-header bg-primary pt-2 pb-2">
              {" "}
              <h3 className="text-white mb-0"> Remote Patient Monitoring</h3>
            </div>
            <div className="card-body">
              <div className="row g-0 align-items-center">
                <div className="col-xl-12">
          ...
          <div className="card mb-3">
            <div className="card-header bg-primary pt-2 pb-2">
              {" "}
              <h3 className="text-white mb-0">BillingRPM & Claims</h3>
            </div>
            <div className="card-body">
              <div className="row g-0 align-items-center">
                <div className="col-xl-12">
                        ...
                        <tr>
                          <td>
                            <Link
                              to="/billing"
                              onClick={() =>
                                setBPatient([...BillingRPM, ...BillingCCM])
                              }
                            >
                          ...
                          <td>
                            <Link to="/billing">2</Link>
                          </td>
                          <td>
                            {" "}
                            <Link to="/Patients">2</Link>
                          </td>
                          <td>
                            <Link to="/Patients">2</Link>
                          </td>
