...
const Patients = (props) => {
      ...
      renderCell: (params) => (
        <div style={{ marginLeft: "1em", paddingBottom: "1em" }}>
          <Link to={`/patient-summary/${btoa(params.row.userId)}`}>
            {" "}
            {params.value} {console.log(params, "edit")}
          </Link>
        </div>
      ),
    },
    ...
    },
    {
      ...
      renderCell: (params) =>
        params.value === "Deactive" ? (
          ...
          <div style={{ marginLeft: "3em", paddingBottom: "1em" }}>Active </div>
        ),
    },
          ...
          params.row.ActiveStatus === "Active" ? (
            ...
            <div style={{ width: "100px" }}>
              <Link
                ...
                to="#"
                onClick={() => {
                  coreContext.ActivatePatient(params.row);
                  coreContext.cleanup1();
                  setChecked(false);
                }}
              >
      ...
      renderCell: (params) => (
        <>
          <div style={{ marginLeft: "2em" }}>
            <input
              type="checkbox"
              checked={params.row.reading === "true"}
              onChange={(e) => {
                coreContext.UpdateNotes(
                  coreContext.patients.filter(
                    (curr) => curr.userId === params.row.userId
                  )[0],
                  "",
                  "",
                  e.target.checked
                ...
                coreContext.fetchPatientListfromApi(
  ...
  const renderPatients = () => {
    ...
    if (
      ...
      coreContext.providerOptions.length > 0 &&
      coreContext.coachOptions.length > 0 &&
      coreContext.careCoordinatorOptions.length > 0
    )
          ...
          <div className="row">
            ...
            <div className="col-sm-1 col-2" style={{ width: "70px" }}>
              <div className="form-group">
                <label for="inputName" className="text-14 mts text-black">
                          ...
                          {curr !== "" ? (
                            <>
                              <select
                                ...
                                value={dcount[index]}
                                onChange={(e) => {
                                  handledcount(index, e.target.value);
                                }}
                              >
                                <option value=""></option>
                                {diagonislist.map((curr) => (
                                  <option value={curr.split("-")[0]}>
                                    {curr}
                                  </option>
                                ))}
                              </select>
                  ...
                  dcount.map((curr,index)=>{
                    return(
                      ...
                      <Button
                        className="mt-1 mb-1"
                        onClick={() =>
                          setdcount([...dcount, "Select Diagnosis Id"])
                        }
                      >
                        +
                      </Button>
